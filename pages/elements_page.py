...
class CheckBoxPage(BasePage):
    ...
    def get_checked_checkboxes(self):
        ...
        for box in checked_list:
            title_item = box.find_elements(By.XPATH, ".//ancestor::span[@class='rct-text']")
...
class WebTablePage(BasePage):
    ...
    def delete_created_person(self):
        self.element_is_visible(self.locators.DELETE_BUTTON).click()

    def check_deleted_person(self):
        return self.element_is_present(self.locators.NO_ROWS_FOUND).text

    def change_quantity_rows(self):
        count = [5, 10]
        data = []
        for x in count:
            count_row_button = (self.element_is_visible(self.locators.ROWS_QUANTITY_DROP_DOWN))
